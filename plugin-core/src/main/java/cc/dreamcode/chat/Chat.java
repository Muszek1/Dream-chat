// java
package cc.dreamcode.chat;

import cc.dreamcode.chat.command.*;
import cc.dreamcode.chat.command.handler.InvalidInputHandlerImpl;
import cc.dreamcode.chat.command.handler.InvalidPermissionHandlerImpl;
import cc.dreamcode.chat.command.handler.InvalidSenderHandlerImpl;
...
import cc.dreamcode.chat.utils.MessageBroadcaster;
...
public final class Chat extends DreamBukkitPlatform implements DreamBukkitConfig, DreamPersistence  {

    @Getter private static Chat instance;
    ...
    public void enable(@NonNull ComponentService componentService) {
        ...
        componentService.registerComponent(cc.dreamcode.chat.config.PluginConfig.class);
        componentService.registerComponent(cc.dreamcode.chat.config.MessageConfig.class);
